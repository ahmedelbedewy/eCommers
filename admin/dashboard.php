					...
					<div class="col-sm-6">
						<div class="panel panel-default">
							<div class="panel-heading">
								<i class="fa fa-users"></i> 
                                                Latest <?php echo count($latestUsers); ?> Registered Users
												...
												echo '<a href="members.php?do=Edit&id=' . $user['ID'] . '">';
													echo '<span class="btn btn-success pull-right">';
														echo '<i class="fa fa-edit"></i> Edit';
                                                                                    if (isset($user['RegStatus']) && $user['RegStatus'] == 0) {
                                                                                          echo "<a href='members.php?do=Activate&id=" . $user['ID'] . "' class='btn btn-info pull-right activate'>
