	...
	if (isset($_SESSION['Username'])) {
		...
		if ($do == 'Manage') {
			...
			<div class="container categories">
							...
							foreach($cats as $cat) {
								echo "<div class='cat'>";
									echo "<div class='hidden-buttons'>";
										echo "<a href='cateogris.php?do=Edit&catid=" . $cat['ID'] . "' class='btn btn-xs btn-primary'><i class='fa fa-edit'></i> Edit</a>";
										echo "<a href='cateogris.php?do=Delete&catid=" . $cat['ID'] . "' class='confirm btn btn-xs btn-danger'><i class='fa fa-close'></i> Delete</a>";
									echo "</div>";
									echo "<h3>" . $cat['Name'] . '</h3>';
							      	...
							      	if (! empty($childCats)) {
										...
										foreach ($childCats as $c) {
											echo "<li class='child-link'>
												<a href='cateogris.php?do=Edit&catid=" . $c['ID'] . "'>" . $c['Name'] . "</a>
												<a href='cateogris.php?do=Delete&catid=" . $c['ID'] . "' class='show-delete confirm'> Delete</a>
											</li>";
										}
										echo "</ul>";
									}
				...
				<a class="add-category btn btn-primary" href="cateogris.php?do=Add"><i class="fa fa-plus"></i> Add New Category</a>
			</div>
								...
								<select name="parent">
									...
									<?php 
										...
										foreach($allCats as $c) {
											...
											if (isset($cat['parent']) && $cat['parent'] == $c['ID']) { 
												echo ' selected'; 
											}
